...
LOG_TYPES = ["EMPTY_FILE", "HAS_BAD_CHARS", "BAD_CHAR", "HAS_LONG_LINES", "EXCEEDS_LINE_LENGTH", "WRONG_CONTACT",
             "INVALID_PDS_FILENAME", "INVALID_DOC_FILE", "INVALID_KERNEL_FILE", "INVALID_TEXT_KERNEL",
             "INVALID_BINARY_KERNEL", "INVALID_METAKERNEL", "WRONG_KERNEL_EXTENSION", "VALID_FILE",
             "UNSUPPORTED_EXTENSION", "SKD_VERSION", "INVALID_FRAMES_KERNEL", "INVALID_INSTRUMENTS_KERNEL",
             "HAS_WRONG_INDENTATION", "HAS_TRAILING_CHARS", "TRAILING_CHARS", "INVALID_CK_KERNEL", "INVALID_SPK_KERNEL",
             "WRONG_MK", "WRONG_KERNEL_HEADER", "WRONG_VERSION_SECTION", "WRONG_RELEASE_NOTES", "DATA_AND_COMMENTS",
             "MISSING_SECTION", "NAIF_IDS", "WRONG_DEFINITIONS", "MISALIGNED_SECTION", "WRONG_INDENTATION",
             "WRONG_KEYWORD", "WRONG_KEYWORD_ORDER"]
